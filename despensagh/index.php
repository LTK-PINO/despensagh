...
$sql = $conn->prepare("SELECT id_producto, Nombre_producto, Precio_Venta, Imagen FROM productos WHERE Populares='Si'");
$sql->execute();
...
<body>
    <header>
        ...
        <nav class="navegacion">
            ...
            <div class="option-nav-derecha">
                ...
                <div class="option-derecha-nav">
                    <a href="carrito.php"><span class="material-symbols-outlined google-icon">shopping_bag</span></a>
                </div>
            </div>
        </nav>
    </header>
    ...
    <div class="contenedor-novedades">
        <h1 class="h1-novedades">Més venut</h1>
