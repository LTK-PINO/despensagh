...
$sql = $conn->prepare("SELECT id_producto, Nombre_producto, Precio_Venta, Imagen FROM productos WHERE Categoria='Pernil'");
$sql->execute();
...
<head>
    ...
    <title>Pernil | Despensa García Haro</title>
...
<body>
    ...
    <div class="contenedor-novedades">
        <h1 class="h1-novedades">Pernil</h1>
        ...
        <!-- <?php 
            ...
            <div class="box-novedades">
                    ...
                    <div class="boton-cesta">
                        <button onclick="location.href='producte.php?id=<?php echo $id; ?>'" type="button">Veure Producte <span class="material-symbols-outlined icono-botones">visibility</span></button></a>
                    </div>
