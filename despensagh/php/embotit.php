...
$sql = $conn->prepare("SELECT id_producto, Nombre_producto, Precio_Venta, Imagen FROM productos WHERE Categoria='Embotit'");
$sql->execute();
...
<head>
    ...
    <title>Embotit | Despensa García Haro</title>
...
<header>
    ...
    <div class="contenedor-novedades">
        <h1 class="h1-novedades">Embotit</h1>
